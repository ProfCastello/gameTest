...
const wordsDatabase = {
    ...
    4: [
        ...
        { word: "ÁGUA", clue: "Líquido incolor essencial à vida" },
        ...
        { word: "CAFÉ", clue: "Bebida estimulante" },
        { word: "CHÃO", clue: "Superfície onde pisamos" }
    ],
    ...
    5: [
        ...
        { word: "MÚSICA", clue: "Arte dos sons" },
        { word: "DANÇA", clue: "Arte do movimento" },
        ...
        { word: "FORÇA", clue: "Energia, poder" },
        { word: "DOCE", clue: "Sabor agradável" },
        { word: "SALGADO", clue: "Com sal" }
    ],
